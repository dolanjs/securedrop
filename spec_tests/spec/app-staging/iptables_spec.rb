...
desired_iptables_rules = [
  ...
  "-A OUTPUT -s 127.0.0.1/32 -d 127.0.0.1/32 -o lo -p tcp -m tcp --sport 6379 -m owner --uid-owner #{property['apache_user_uid']} -m state --state RELATED,ESTABLISHED -j ACCEPT",
